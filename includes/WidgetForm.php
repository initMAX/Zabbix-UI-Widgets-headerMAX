...
class WidgetForm extends CWidgetForm
{
	public function addFields(): self
	{
		return $this
			...
			->addField(
				(new CWidgetFieldRadioButtonList('text_align', _('Text align'), [
					Widget::TEXT_ALIGN_LEFT => _('Left'),
					Widget::TEXT_ALIGN_CENTER => _('Center'),
					Widget::TEXT_ALIGN_RIGHT => _('Right'),
				]))->setDefault(Widget::TEXT_ALIGN_CENTER)
			)
		;
	}
