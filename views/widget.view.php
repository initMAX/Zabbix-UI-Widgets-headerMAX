...
$textAlign = match($this->data['fields_values']['text_align']) {
	Widget::TEXT_ALIGN_LEFT => 'flex-start',
	Widget::TEXT_ALIGN_CENTER => 'center',
	Widget::TEXT_ALIGN_RIGHT => 'flex-end',
...
$wrapper_style->append('justify-content: '. $textAlign);
