...
Everything lives in one familiar widget form - pick **text or HTML** and choose font, size, colours and alignment. PRO adds the one-click presets; every PRO-only field stays visible inline in FREE, greyed out with a padlock.
