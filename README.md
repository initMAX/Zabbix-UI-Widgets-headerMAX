...
Minimum required Zabbix version 7.0.0

<!-- *********************************************************************************************************************************** -->
<br>

## Description
The Zabbix header widget displays custom text and can be used as a header for sections with widgets or as a button with a linked URL.

You can customize the content in the following ways:
- **Customizable Text**: Input and format text using HTML tags.
- **Font Options**: Adjust font family, size, and style.
- **Text Alignment**: Align text to the left, center, or right.
- **Color Customization**: Set font and background colors.
...
- Change the owner of directory to your web user with `chown`
  - default OS users
    - nginx
        ```sh
        chown nginx:nginx ./Zabbix-UI-Modules-Header-Widget
        ``` 
    - apache (RHEL)
        ```sh
        chown apache:apache ./Zabbix-UI-Modules-Header-Widget
        ``` 
    - apache (DEB)
        ```sh
        chown www-data:www-data ./Zabbix-UI-Modules-Header-Widget
        ``` 
