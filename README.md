...
<div align="center">
    ...
    <h4>
        A highly customizable header widget for Zabbix dashboards
    </h4>
    <br>
    <img alt="Static Badge" src="https://img.shields.io/badge/Required%20Zabbix%20version-7.0,%207.2-red">
    <img alt="Static Badge" src="https://img.shields.io/badge/Required%20php%20version-8.0-blue">
    <br>
    <img src="./.readme/screen/headerMAX.png" width="800">
</div>
<br>
<br>

## Description
headerMAX is a flexible widget designed for Zabbix dashboards that allows you to create customizable text headers and interactive buttons with rich formatting options. Perfect for organizing dashboard sections, improving navigation, and creating visually distinct interactive elements.

<div align="center">
    <a href="https://www.initmax.com/wiki/headermax/" style="display: inline-block; padding: 10px 20px; font-size: 16px; color: white; background-color: #007BFF; text-decoration: none; border-radius: 5px;">headerMAX Documentation</a>
</div>
